...
def test_mzi2x2_2x2_phase_shifter():
    ...
    # Currently
    # print(json.dumps(our_mzi_phase_shifter_netlist_electrical, sort_keys=True, indent=4))
    # print(our_mzi_phase_shifter.ports)
    # print(sax.get_required_circuit_models(our_mzi_phase_shifter_netlist_electrical))
